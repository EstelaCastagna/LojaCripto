...
public class ConstVeicModel {
    ...
    public ConstVeicModel(int id_veiculo, String chassi_veiculo, int id_modelo, String nome_modelo, int id_cor, String nome_cor, String versao_modelo) {
    ...
    public ConstVeicModel(int id_veiculo, String chassi_veiculo, int id_modelo, String nome_modelo, int id_cor, String nome_cor, String versao_modelo, int id_ano_fabricacao, int id_ano_modelo, int id_combustivel, int id_cambio, String status_veiculo, float preco_veiculo) {
        this.id_veiculo = id_veiculo;
        this.chassi_veiculo = chassi_veiculo;
        this.id_modelo = id_modelo;
        this.nome_modelo = nome_modelo;
   ...
   public String mostrarDados (){
        ...
        return"ID:"+getId_veiculo()+" | "+"Chassi: "+getChassi_veiculo()+" | Modelo: "+getNome_modelo()+" | Cor: "+getNome_cor()+" | Versão: "+getVersao_modelo()+"\n";
    }
