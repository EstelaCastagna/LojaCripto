...
public class TelaListaClientes extends javax.swing.JFrame {
    ...
    private ArrayList<Clientes> telefonePF = new ArrayList<>();
    ...
    public TelaListaClientes() {
        ...
        this.pf = db.readAllPessoaFisica();
        this.telefonePF = db.readTelCEPClientesPF();
        preencherTabela();
    ...
    private void limparTabela(){
        ...
        preencherTabela();
        for (int i = 0; i < 40; i++) {
            TabelaListaCliente.setValueAt("", i, 0);
            TabelaListaCliente.setValueAt("", i, 1);
            TabelaListaCliente.setValueAt("", i, 2);
            TabelaListaCliente.setValueAt("", i, 3);
            TabelaListaCliente.setValueAt("", i, 4);
        }
    }

    private void preencherTabela() {
        TabelaListaCliente.removeAll();
        //limpar a table
        

        for (int i = 0; i < pf.size(); i++) {
            TabelaListaCliente.setValueAt(pf.get(i).getId_pessoa_fisica(), i, 0);
            TabelaListaCliente.setValueAt(pf.get(i).getNome_pessoa_fisica(), i, 1);
            TabelaListaCliente.setValueAt(pf.get(i).getSobrenome_pessoa_fisica(), i, 2);
            TabelaListaCliente.setValueAt(pf.get(i).getCpf_pessoa_fisica(), i, 3);
            TabelaListaCliente.setValueAt(telefonePF.get(i).getTelefone_cliente(), i, 4);
        }
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        TelaAtualizarClienteF tacf = new TelaAtualizarClienteF();
        tacf.setVisible(true);
        setVisible(false);
